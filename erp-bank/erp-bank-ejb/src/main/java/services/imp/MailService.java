...
public class MailService {
    ...
    private static final String USER = "dreambank2015@gmail.com";     // Must be valid user in d.umn.edu domain, e.g. "smit0012"
    private static final String PASSWORD = "DreamBank@2015"; // Must be valid password for smit0012
    private static final String FROM = "dreambank2015@gmail.com";     // Full info for user, e.g. "Fred Smith <smit0012@d.umn.edu>"
}